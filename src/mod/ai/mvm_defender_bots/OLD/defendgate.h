#ifndef _INCLUDE_SIGSEGV_MOD_AI_MVM_DEFENDER_BOTS_DEFENDGATE_H_
#define _INCLUDE_SIGSEGV_MOD_AI_MVM_DEFENDER_BOTS_DEFENDGATE_H_
...
namespace Mod::AI::MvM_Defender_Bots
{
	...
	public:
		...
		virtual const char *GetName() const override { return "MvMDefendGate"; }
		/*
